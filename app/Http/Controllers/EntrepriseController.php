...
class EntrepriseController extends Controller
{
    ...
    public function store(Request $request)
    {
        try {
            ...
            $entreprise->save();
                return $this->successResponse($entreprise, 'Récupération réussie');
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            $entreprise->telephone = $request->telephone;
            $entreprise->save();
                return $this->successResponse($entreprise, 'Mise à jour réussie');
        } catch (Exception $e) {
    ...
    public function destroy($id)
    {
        try {
            $entreprise = Entreprise::findOrFail($id);
            $entreprise->delete();
                return $this->successResponse($entreprise, 'Suppression réussie');
        } catch (Exception $e) {
    ...
    public function show($id)
    {
        try {
            $entreprise = Entreprise::findOrFail($id);
             return $this->successResponse($entreprise, 'Ressource trouvée');
        } catch (Exception $e) {
